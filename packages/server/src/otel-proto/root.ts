      ...
      common.v1 = (() => {
        ...
        v1.AnyValue = (() => {
          ...
          AnyValue.encode = function encode(message, writer) {
            ...
            if (message.stringValue != null && Object.hasOwn(message, "stringValue"))
              writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.stringValue);
            if (message.boolValue != null && Object.hasOwn(message, "boolValue"))
              writer.uint32(/* id 2, wireType 0 =*/ 16).bool(message.boolValue);
            if (message.intValue != null && Object.hasOwn(message, "intValue"))
              writer.uint32(/* id 3, wireType 0 =*/ 24).int64(message.intValue);
            if (message.doubleValue != null && Object.hasOwn(message, "doubleValue"))
              writer.uint32(/* id 4, wireType 1 =*/ 33).double(message.doubleValue);
            if (message.arrayValue != null && Object.hasOwn(message, "arrayValue"))
              $root.opentelemetry.proto.common.v1.ArrayValue.encode(
                message.arrayValue,
                writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
              ).ldelim();
            if (message.kvlistValue != null && Object.hasOwn(message, "kvlistValue"))
              $root.opentelemetry.proto.common.v1.KeyValueList.encode(
                message.kvlistValue,
                writer.uint32(/* id 6, wireType 2 =*/ 50).fork(),
              ).ldelim();
            if (message.bytesValue != null && Object.hasOwn(message, "bytesValue"))
          ...
          AnyValue.toObject = function toObject(message, options) {
            ...
            if (message.doubleValue != null && Object.hasOwn(message, "doubleValue")) {
              object.doubleValue =
                options.json && !Number.isFinite(message.doubleValue)
        ...
        v1.ArrayValue = (() => {
          ...
          ArrayValue.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1: {
                  if (!message.values?.length) message.values = [];
                  message.values.push(
          ...
          ArrayValue.verify = function verify(message) {
            if (typeof message !== "object" || message === null) return "object expected";
            if (message.values != null && Object.hasOwn(message, "values")) {
        ...
        v1.KeyValue = (() => {
          ...
          KeyValue.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.key != null && Object.hasOwn(message, "key"))
          ...
          KeyValue.toObject = function toObject(message, options) {
            ...
            if (message.key != null && Object.hasOwn(message, "key")) object.key = message.key;
            if (message.value != null && Object.hasOwn(message, "value"))
        ...
        v1.InstrumentationScope = (() => {
          ...
          InstrumentationScope.encode = function encode(message, writer) {
            ...
            if (
              ...
              Object.hasOwn(message, "droppedAttributesCount")
            )
          ...
          InstrumentationScope.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 3: {
                  if (!message.attributes?.length) message.attributes = [];
          ...
          InstrumentationScope.verify = function verify(message) {
            ...
            if (message.attributes != null && Object.hasOwn(message, "attributes")) {
      ...
      trace.v1 = (() => {
        ...
        v1.TracesData = (() => {
          ...
          TracesData.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1: {
                  if (!message.resourceSpans?.length) message.resourceSpans = [];
          ...
          TracesData.verify = function verify(message) {
            if (typeof message !== "object" || message === null) return "object expected";
            if (message.resourceSpans != null && Object.hasOwn(message, "resourceSpans")) {
        ...
        v1.ResourceSpans = (() => {
          ...
          ResourceSpans.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.resource != null && Object.hasOwn(message, "resource"))
            ...
            if (message.schemaUrl != null && Object.hasOwn(message, "schemaUrl"))
          ...
          ResourceSpans.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.scopeSpans?.length) message.scopeSpans = [];
          ...
          ResourceSpans.verify = function verify(message) {
            ...
            if (message.scopeSpans != null && Object.hasOwn(message, "scopeSpans")) {
              if (!Array.isArray(message.scopeSpans)) return "scopeSpans: array expected";
              for (var i = 0; i < message.scopeSpans.length; ++i) {
                var error = $root.opentelemetry.proto.trace.v1.ScopeSpans.verify(
                  message.scopeSpans[i],
                );
          ...
          ResourceSpans.fromObject = function fromObject(object) {
            ...
            if (object.scopeSpans) {
              ...
              for (var i = 0; i < object.scopeSpans.length; ++i) {
                ...
                message.scopeSpans[i] = $root.opentelemetry.proto.trace.v1.ScopeSpans.fromObject(
                  object.scopeSpans[i],
                );
              }
            }
        ...
        v1.ScopeSpans = (() => {
          ...
          ScopeSpans.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.scope != null && Object.hasOwn(message, "scope"))
          ...
          ScopeSpans.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.spans?.length) message.spans = [];
                  message.spans.push(
          ...
          ScopeSpans.verify = function verify(message) {
            if (typeof message !== "object" || message === null) return "object expected";
            if (message.scope != null && Object.hasOwn(message, "scope")) {
              var error = $root.opentelemetry.proto.common.v1.InstrumentationScope.verify(
                message.scope,
              );
              if (error) return `scope.${error}`;
            }
            if (message.spans != null && Object.hasOwn(message, "spans")) {
          ...
          ScopeSpans.fromObject = function fromObject(object) {
            ...
            if (object.scope != null) {
              ...
              message.scope = $root.opentelemetry.proto.common.v1.InstrumentationScope.fromObject(
                object.scope,
              );
            }
            if (object.spans) {
          ...
          ScopeSpans.toObject = function toObject(message, options) {
            ...
            if (message.scope != null && Object.hasOwn(message, "scope"))
              object.scope = $root.opentelemetry.proto.common.v1.InstrumentationScope.toObject(
                message.scope,
                options,
              );
            if (message.spans?.length) {
        ...
        v1.Span = (() => {
          ...
          Span.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.traceId != null && Object.hasOwn(message, "traceId"))
              writer.uint32(/* id 1, wireType 2 =*/ 10).bytes(message.traceId);
            if (message.spanId != null && Object.hasOwn(message, "spanId"))
              writer.uint32(/* id 2, wireType 2 =*/ 18).bytes(message.spanId);
            if (message.traceState != null && Object.hasOwn(message, "traceState"))
              writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.traceState);
            if (message.parentSpanId != null && Object.hasOwn(message, "parentSpanId"))
              writer.uint32(/* id 4, wireType 2 =*/ 34).bytes(message.parentSpanId);
            if (message.name != null && Object.hasOwn(message, "name"))
              writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.name);
            if (message.kind != null && Object.hasOwn(message, "kind"))
              writer.uint32(/* id 6, wireType 0 =*/ 48).int32(message.kind);
            if (message.startTimeUnixNano != null && Object.hasOwn(message, "startTimeUnixNano"))
              writer.uint32(/* id 7, wireType 1 =*/ 57).fixed64(message.startTimeUnixNano);
            if (message.endTimeUnixNano != null && Object.hasOwn(message, "endTimeUnixNano"))
            ...
            if (message.droppedEventsCount != null && Object.hasOwn(message, "droppedEventsCount"))
            ...
            if (message.droppedLinksCount != null && Object.hasOwn(message, "droppedLinksCount"))
              writer.uint32(/* id 14, wireType 0 =*/ 112).uint32(message.droppedLinksCount);
            if (message.status != null && Object.hasOwn(message, "status"))
          ...
          Span.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 11: {
                  if (!message.events?.length) message.events = [];
                  message.events.push(
                ...
                case 13: {
                  if (!message.links?.length) message.links = [];
                  message.links.push(
          ...
          Span.verify = function verify(message) {
            ...
            if (
              ...
              if (!$util.isInteger(message.droppedAttributesCount))
                return "droppedAttributesCount: integer expected";
            if (message.events != null && Object.hasOwn(message, "events")) {
            ...
            if (message.links != null && Object.hasOwn(message, "links")) {
          ...
          Span.fromObject = function fromObject(object) {
            ...
            if (object.endTimeUnixNano != null)
              if ($util.Long)
                (message.endTimeUnixNano = $util.Long.fromValue(object.endTimeUnixNano)).unsigned =
                  false;
          ...
          Span.Event = (() => {
            ...
            Event.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.timeUnixNano != null && Object.hasOwn(message, "timeUnixNano"))
            ...
            Event.fromObject = function fromObject(object) {
              ...
              if (object.timeUnixNano != null)
                if ($util.Long)
                  (message.timeUnixNano = $util.Long.fromValue(object.timeUnixNano)).unsigned =
                    false;
        ...
        v1.Status = (() => {
          ...
          Status.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.message != null && Object.hasOwn(message, "message"))
              writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.message);
            if (message.code != null && Object.hasOwn(message, "code"))
    ...
    proto.collector = (() => {
        ...
        trace.v1 = (() => {
          ...
          v1.ExportTraceServiceResponse = (() => {
            ...
            ExportTraceServiceResponse.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.partialSuccess != null && Object.hasOwn(message, "partialSuccess"))
          ...
          v1.ExportTracePartialSuccess = (() => {
            ...
            ExportTracePartialSuccess.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.rejectedSpans != null && Object.hasOwn(message, "rejectedSpans"))
                writer.uint32(/* id 1, wireType 0 =*/ 8).int64(message.rejectedSpans);
              if (message.errorMessage != null && Object.hasOwn(message, "errorMessage"))
            ...
            ExportTracePartialSuccess.fromObject = function fromObject(object) {
              if (
                object instanceof
                $root.opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess
              )
                return object;
              var message =
                new $root.opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess();
              if (object.rejectedSpans != null)
                if ($util.Long)
                  (message.rejectedSpans = $util.Long.fromValue(object.rejectedSpans)).unsigned =
                    false;
      ...
      collector.metrics = (() => {
        ...
        metrics.v1 = (() => {
          ...
          v1.ExportMetricsServiceRequest = (() => {
            ...
            ExportMetricsServiceRequest.decode = function decode(reader, length) {
              ...
              while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                  case 1: {
                    if (!message.resourceMetrics?.length) message.resourceMetrics = [];
            ...
            ExportMetricsServiceRequest.verify = function verify(message) {
              if (typeof message !== "object" || message === null) return "object expected";
              if (message.resourceMetrics != null && Object.hasOwn(message, "resourceMetrics")) {
          ...
          v1.ExportMetricsServiceResponse = (() => {
            /**
          ...
          v1.ExportMetricsPartialSuccess = (() => {
            /**
            ...
            ExportMetricsPartialSuccess.encode = function encode(message, writer) {
              ...
              if (
                ...
                Object.hasOwn(message, "rejectedDataPoints")
              )
             ...
             * @returns {$protobuf.Writer} Writer
             */
            ExportMetricsPartialSuccess.encodeDelimited = function encodeDelimited(
              message,
              writer,
            ) {
              return this.encode(message, writer).ldelim();
            ...
            ExportMetricsPartialSuccess.fromObject = function fromObject(object) {
              if (
                object instanceof
                $root.opentelemetry.proto.collector.metrics.v1.ExportMetricsPartialSuccess
              )
                return object;
              var message =
                new $root.opentelemetry.proto.collector.metrics.v1.ExportMetricsPartialSuccess();
      ...
      collector.logs = (() => {
        ...
        logs.v1 = (() => {
          ...
          v1.LogsService = (() => {
            ...
            (LogsService.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor =
              LogsService;
            /**
          ...
          v1.ExportLogsServiceRequest = (() => {
            ...
            ExportLogsServiceRequest.decode = function decode(reader, length) {
              ...
              while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                  case 1: {
                    if (!message.resourceLogs?.length) message.resourceLogs = [];
            ...
            ExportLogsServiceRequest.verify = function verify(message) {
              if (typeof message !== "object" || message === null) return "object expected";
              if (message.resourceLogs != null && Object.hasOwn(message, "resourceLogs")) {
                if (!Array.isArray(message.resourceLogs)) return "resourceLogs: array expected";
                for (var i = 0; i < message.resourceLogs.length; ++i) {
                  var error = $root.opentelemetry.proto.logs.v1.ResourceLogs.verify(
                    message.resourceLogs[i],
                  );
          ...
          v1.ExportLogsPartialSuccess = (() => {
            ...
            ExportLogsPartialSuccess.encode = function encode(message, writer) {
              ...
              if (
                ...
                Object.hasOwn(message, "rejectedLogRecords")
              )
            ...
            ExportLogsPartialSuccess.fromObject = function fromObject(object) {
              if (
                object instanceof
                $root.opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess
              )
                return object;
              var message =
                new $root.opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess();
      ...
      metrics.v1 = (() => {
        ...
        v1.ResourceMetrics = (() => {
          ...
          ResourceMetrics.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.scopeMetrics?.length) message.scopeMetrics = [];
          ...
          ResourceMetrics.verify = function verify(message) {
            ...
            if (message.scopeMetrics != null && Object.hasOwn(message, "scopeMetrics")) {
              if (!Array.isArray(message.scopeMetrics)) return "scopeMetrics: array expected";
              for (var i = 0; i < message.scopeMetrics.length; ++i) {
                var error = $root.opentelemetry.proto.metrics.v1.ScopeMetrics.verify(
                  message.scopeMetrics[i],
                );
        ...
        v1.ScopeMetrics = (() => {
          ...
          ScopeMetrics.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.metrics?.length) message.metrics = [];
          ...
          ScopeMetrics.verify = function verify(message) {
            ...
            if (message.metrics != null && Object.hasOwn(message, "metrics")) {
        ...
        v1.Metric = (() => {
          ...
          Metric.encode = function encode(message, writer) {
            ...
            if (message.unit != null && Object.hasOwn(message, "unit"))
              writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.unit);
            if (message.gauge != null && Object.hasOwn(message, "gauge"))
              $root.opentelemetry.proto.metrics.v1.Gauge.encode(
                message.gauge,
                writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
              ).ldelim();
            if (message.sum != null && Object.hasOwn(message, "sum"))
              $root.opentelemetry.proto.metrics.v1.Sum.encode(
                message.sum,
                writer.uint32(/* id 7, wireType 2 =*/ 58).fork(),
              ).ldelim();
            if (message.histogram != null && Object.hasOwn(message, "histogram"))
            ...
            if (
              ...
              Object.hasOwn(message, "exponentialHistogram")
            )
              $root.opentelemetry.proto.metrics.v1.ExponentialHistogram.encode(
                message.exponentialHistogram,
                writer.uint32(/* id 10, wireType 2 =*/ 82).fork(),
              ).ldelim();
            if (message.summary != null && Object.hasOwn(message, "summary"))
          ...
          Metric.toObject = function toObject(message, options) {
            ...
            if (message.unit != null && Object.hasOwn(message, "unit")) object.unit = message.unit;
            if (message.gauge != null && Object.hasOwn(message, "gauge")) {
        ...
        v1.Gauge = (() => {
          ...
          Gauge.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1: {
                  if (!message.dataPoints?.length) message.dataPoints = [];
          ...
          Gauge.verify = function verify(message) {
            if (typeof message !== "object" || message === null) return "object expected";
            if (message.dataPoints != null && Object.hasOwn(message, "dataPoints")) {
        ...
        v1.Sum = (() => {
          ...
          Sum.encode = function encode(message, writer) {
            ...
            if (
              ...
              Object.hasOwn(message, "aggregationTemporality")
            )
              writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.aggregationTemporality);
            if (message.isMonotonic != null && Object.hasOwn(message, "isMonotonic"))
        ...
        v1.NumberDataPoint = (() => {
          ...
          NumberDataPoint.encode = function encode(message, writer) {
            ...
            if (message.asDouble != null && Object.hasOwn(message, "asDouble"))
            ...
            if (message.asInt != null && Object.hasOwn(message, "asInt"))
            ...
            if (message.flags != null && Object.hasOwn(message, "flags"))
          ...
          NumberDataPoint.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 5: {
                  if (!message.exemplars?.length) message.exemplars = [];
          ...
          NumberDataPoint.verify = function verify(message) {
            ...
            if (message.exemplars != null && Object.hasOwn(message, "exemplars")) {
          ...
          NumberDataPoint.toObject = function toObject(message, options) {
            ...
            if (message.asDouble != null && Object.hasOwn(message, "asDouble")) {
              object.asDouble =
                options.json && !Number.isFinite(message.asDouble)
        ...
        v1.HistogramDataPoint = (() => {
          ...
          HistogramDataPoint.encode = function encode(message, writer) {
            ...
            if (message.timeUnixNano != null && Object.hasOwn(message, "timeUnixNano"))
              writer.uint32(/* id 3, wireType 1 =*/ 25).fixed64(message.timeUnixNano);
            if (message.count != null && Object.hasOwn(message, "count"))
            ...
            if (message.min != null && Object.hasOwn(message, "min"))
              writer.uint32(/* id 11, wireType 1 =*/ 89).double(message.min);
            if (message.max != null && Object.hasOwn(message, "max"))
          ...
          HistogramDataPoint.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 6: {
                  if (!message.bucketCounts?.length) message.bucketCounts = [];
                  if ((tag & 7) === 2) {
                ...
                case 7: {
                  if (!message.explicitBounds?.length) message.explicitBounds = [];
                  if ((tag & 7) === 2) {
                    var end2 = reader.uint32() + reader.pos;
          ...
          HistogramDataPoint.verify = function verify(message) {
            ...
            if (message.bucketCounts != null && Object.hasOwn(message, "bucketCounts")) {
            ...
            if (message.explicitBounds != null && Object.hasOwn(message, "explicitBounds")) {
          ...
          HistogramDataPoint.toObject = function toObject(message, options) {
            ...
            if (message.sum != null && Object.hasOwn(message, "sum")) {
              object.sum =
                options.json && !Number.isFinite(message.sum) ? String(message.sum) : message.sum;
            ...
            if (message.explicitBounds?.length) {
              ...
              for (var j = 0; j < message.explicitBounds.length; ++j)
                object.explicitBounds[j] =
                  options.json && !Number.isFinite(message.explicitBounds[j])
            ...
            if (message.min != null && Object.hasOwn(message, "min")) {
              object.min =
                options.json && !Number.isFinite(message.min) ? String(message.min) : message.min;
              if (options.oneofs) object._min = "min";
            }
            if (message.max != null && Object.hasOwn(message, "max")) {
              object.max =
                options.json && !Number.isFinite(message.max) ? String(message.max) : message.max;
        ...
        v1.ExponentialHistogramDataPoint = (() => {
          ...
          ExponentialHistogramDataPoint.encode = function encode(message, writer) {
            ...
            if (message.sum != null && Object.hasOwn(message, "sum"))
              writer.uint32(/* id 5, wireType 1 =*/ 41).double(message.sum);
            if (message.scale != null && Object.hasOwn(message, "scale"))
              writer.uint32(/* id 6, wireType 0 =*/ 48).sint32(message.scale);
            if (message.zeroCount != null && Object.hasOwn(message, "zeroCount"))
              writer.uint32(/* id 7, wireType 1 =*/ 57).fixed64(message.zeroCount);
            if (message.positive != null && Object.hasOwn(message, "positive"))
              $root.opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets.encode(
                message.positive,
                writer.uint32(/* id 8, wireType 2 =*/ 66).fork(),
              ).ldelim();
            if (message.negative != null && Object.hasOwn(message, "negative"))
              $root.opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets.encode(
                message.negative,
                writer.uint32(/* id 9, wireType 2 =*/ 74).fork(),
              ).ldelim();
            ...
            if (message.zeroThreshold != null && Object.hasOwn(message, "zeroThreshold"))
          ...
          ExponentialHistogramDataPoint.toObject = function toObject(message, options) {
            ...
            if (message.zeroThreshold != null && Object.hasOwn(message, "zeroThreshold"))
              object.zeroThreshold =
                options.json && !Number.isFinite(message.zeroThreshold)
        ...
        v1.SummaryDataPoint = (() => {
          ...
          SummaryDataPoint.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 6: {
                  if (!message.quantileValues?.length) message.quantileValues = [];
          ...
          SummaryDataPoint.verify = function verify(message) {
            ...
            if (message.sum != null && Object.hasOwn(message, "sum"))
              if (typeof message.sum !== "number") return "sum: number expected";
            if (message.quantileValues != null && Object.hasOwn(message, "quantileValues")) {
          ...
          SummaryDataPoint.ValueAtQuantile = (() => {
            ...
            ValueAtQuantile.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.quantile != null && Object.hasOwn(message, "quantile"))
            ...
            ValueAtQuantile.toObject = function toObject(message, options) {
              ...
              if (message.quantile != null && Object.hasOwn(message, "quantile"))
                object.quantile =
                  options.json && !Number.isFinite(message.quantile)
                    ? String(message.quantile)
                    : message.quantile;
              if (message.value != null && Object.hasOwn(message, "value"))
                object.value =
                  options.json && !Number.isFinite(message.value)
        ...
        v1.Exemplar = (() => {
          ...
          Exemplar.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 7: {
                  if (!message.filteredAttributes?.length) message.filteredAttributes = [];
          ...
          Exemplar.verify = function verify(message) {
            ...
            if (
              ...
              Object.hasOwn(message, "filteredAttributes")
            ) {
      ...
      logs.v1 = (() => {
        ...
        v1.ResourceLogs = (() => {
          ...
          ResourceLogs.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.scopeLogs?.length) message.scopeLogs = [];
                  message.scopeLogs.push(
                    $root.opentelemetry.proto.logs.v1.ScopeLogs.decode(reader, reader.uint32()),
                  );
                  break;
                }
                case 3: {
          ...
          ResourceLogs.verify = function verify(message) {
            ...
            if (message.scopeLogs != null && Object.hasOwn(message, "scopeLogs")) {
          ...
          ResourceLogs.fromObject = function fromObject(object) {
            ...
            if (object.scopeLogs) {
              ...
              for (var i = 0; i < object.scopeLogs.length; ++i) {
                ...
                message.scopeLogs[i] = $root.opentelemetry.proto.logs.v1.ScopeLogs.fromObject(
                  object.scopeLogs[i],
                );
              }
            }
        ...
        v1.ScopeLogs = (() => {
          ...
          ScopeLogs.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2: {
                  if (!message.logRecords?.length) message.logRecords = [];
                  message.logRecords.push(
                    $root.opentelemetry.proto.logs.v1.LogRecord.decode(reader, reader.uint32()),
                  );
                  break;
                }
                case 3: {
          ...
          ScopeLogs.verify = function verify(message) {
            ...
            if (message.logRecords != null && Object.hasOwn(message, "logRecords")) {
          ...
          ScopeLogs.fromObject = function fromObject(object) {
            ...
            if (object.logRecords) {
              ...
              for (var i = 0; i < object.logRecords.length; ++i) {
                ...
                message.logRecords[i] = $root.opentelemetry.proto.logs.v1.LogRecord.fromObject(
                  object.logRecords[i],
                );
              }
            }
        ...
        v1.LogRecord = (() => {
          ...
          LogRecord.encode = function encode(message, writer) {
            ...
            if (message.timeUnixNano != null && Object.hasOwn(message, "timeUnixNano"))
              writer.uint32(/* id 1, wireType 1 =*/ 9).fixed64(message.timeUnixNano);
            if (message.severityNumber != null && Object.hasOwn(message, "severityNumber"))
              writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.severityNumber);
            if (message.severityText != null && Object.hasOwn(message, "severityText"))
              writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.severityText);
            if (message.body != null && Object.hasOwn(message, "body"))
              $root.opentelemetry.proto.common.v1.AnyValue.encode(
                message.body,
                writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
              ).ldelim();
            ...
            if (
              ...
              Object.hasOwn(message, "observedTimeUnixNano")
            )
          ...
          LogRecord.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 5: {
                  message.body = $root.opentelemetry.proto.common.v1.AnyValue.decode(
                    reader,
                    reader.uint32(),
                  );
                  break;
          ...
          LogRecord.toObject = function toObject(message, options) {
            ...
            if (message.body != null && Object.hasOwn(message, "body"))
              object.body = $root.opentelemetry.proto.common.v1.AnyValue.toObject(
                message.body,
                options,
              );
            if (message.attributes?.length) {
