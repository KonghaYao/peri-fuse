import { Button, DialogDescription, DialogTitle, InlineForm } from "@peri/ui";
    ...
    >
      ...
      <InlineForm.Field>
        <select
          ...
          class="h-32 w-full rounded-md border border-border bg-background px-8 text-sm"
        >
      ...
      <InlineForm.Actions>
        <Button type="submit" size="sm" disabled={props.searchState === "loading"}>
          <Search size={16} />
          Search
        </Button>
