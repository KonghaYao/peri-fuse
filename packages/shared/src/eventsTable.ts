...
export const eventsTableIsRootObservationSql = "(e.parent_span_id = '' OR e.is_app_root = true)";
...
export const eventsTableCols = eventsTableColsDefinition as unknown as MutableDeep<
...
export const isNumericEventsTableColumnId = (
  ...
  eventsTableColsDefinition.some((col) => col.id === column && col.type === "number");
