...
import type { DimensionsDeclarationType, ViewDeclarationType, ViewVersion, views } from "./types";
  ...
  return {
    ...
    measures: {
      ...
      value: {
        ...
        alias: "value",
        type: "number",
        description: "Numeric 0/1 value of the score. Its average is the true-rate.",
      },
    },
    tableRelations: createScoreTableRelations(version),
    segments: [
...
export const scoresBooleanView: ViewDeclarationType = scoresBooleanViewBase("v1");
...
export const scoresBooleanViewV2: ViewDeclarationType = scoresBooleanViewBase("v2");
