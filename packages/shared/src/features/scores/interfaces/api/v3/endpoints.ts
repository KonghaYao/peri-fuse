import { z } from "zod";
import { ScoreDataTypeArray, ScoreSourceArray } from "../../../../../domain/scores";
import {
...
export const SCORE_FIELD_GROUPS_V3 = ["core", "details", "subject", "annotation"] as const;
...
const csvEnumParam = <T extends readonly string[]>(allowedValues: T, label: string) =>
  z
    .string()
    .transform((val) =>
      val
...
export const GetScoresQueryV3 = z
  .object({
    ...
    valueMin: z.preprocess((v) => (v === "" ? undefined : v), z.coerce.number().optional()),
    valueMax: z.preprocess((v) => (v === "" ? undefined : v), z.coerce.number().optional()),
    ...
    fromTimestamp: z.preprocess((v) => (v === "" ? undefined : v), z.coerce.date().optional()),
    toTimestamp: z.preprocess((v) => (v === "" ? undefined : v), z.coerce.date().optional()),
