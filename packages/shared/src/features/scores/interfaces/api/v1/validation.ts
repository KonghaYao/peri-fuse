...
export const filterAndValidateLegacyV1GetScoreList = (
  scores: unknown[],

  onParseError?: (error: z.ZodError) => void,
): z.infer<typeof GetScoreResponseDataV1>[] =>
  scores.reduce<z.infer<typeof GetScoreResponseDataV1>[]>((acc, ts) => {
 ...
 */
export const filterAndValidateV1GetScoreList = filterAndValidateLegacyV1GetScoreList;
