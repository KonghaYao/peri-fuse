...
import {
  ...
  type ScoreDomain,
  ScoreSchema,
  type ScoresByDataTypes,
} from "../../../../domain";
import { APIScoreSchemaV1, type APIScoreV1 } from "../api/v1/schemas";
...
export const filterAndValidateDbLegacyTraceScoreList = <IncludeHasMetadata extends boolean>({
  scores,
  includeHasMetadata = false as IncludeHasMetadata,
  onParseError,
}: {
 ...
 */
export const filterAndValidateDbTraceScoreList = filterAndValidateDbLegacyTraceScoreList;
