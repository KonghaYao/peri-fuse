...
export type TraceDeleteBatchActionConfig = z.infer<typeof TraceDeleteBatchActionConfigSchema>;

export type TraceDeleteBatchActionCursor = z.infer<typeof TraceDeleteCursorSchema>;
