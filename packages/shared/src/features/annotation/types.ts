import z from "zod";
import { CategoricalData, NumericData, TextData } from "../../domain";
...
>(
  ...
  data.dataType === "BOOLEAN" ? { ...data, value: data.stringValue === "True" ? 1 : 0 } : data;
...
export const CreateAnnotationScoreData = CreateAnnotationScoreBase.and(
  z.discriminatedUnion("dataType", [NumericData, CategoricalData, AnnotationBooleanData, TextData]),
