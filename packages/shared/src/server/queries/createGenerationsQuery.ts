...
import type { EventsObservation, Observation, ObservationCoreFields } from "../../domain";
...
export type FullEventsObservation = AdditionalObservationFields & EventsObservation;
...
export type EventsObservationPublic = Partial<EventsObservation & ObservationPriceFields> &
