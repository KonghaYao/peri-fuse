import { Prisma, type ProjectMembership, prisma, type Role } from "../../db";
...
export function resolveProjectRole({
  ...
  return (projectMemberships.find((membership) => membership.projectId === projectId)?.role ??
    orgMembershipRole) as Role;
}
