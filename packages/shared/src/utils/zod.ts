...
export const optionalJsonParam = <T extends z.ZodType>(schema: T, paramName: string) =>
  z
    .string()
    .optional()
    .transform((str) => {
...
> = TDefault extends null ? Array<TValues[number]> | null : Array<TValues[number]>;
...
export const JSONPrimitiveValueSchema = z.union([z.string(), z.number(), z.boolean()]);
