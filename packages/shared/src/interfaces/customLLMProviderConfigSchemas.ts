...
export const LLMConnectionConfigValueSchema = z.union([z.string(), z.boolean()]);
export const LLMConnectionConfigSchema = z.record(z.string(), LLMConnectionConfigValueSchema);
...
export const BedrockCredentialSchema = z.union([BedrockAccessKeysSchema, BedrockApiKeySchema]);
