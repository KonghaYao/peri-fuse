...
allowed-tools:
  ...
  - Bash(bun scripts/analyze.ts *)
  - Bash(bun scripts/trace-search.ts *)
  - Bash(bun scripts/trace-tree.ts *)
  - Bash(bun scripts/trace-tokens.ts *)
  - Bash(bun scripts/trace-messages.ts *)
  - Bash(bun scripts/prompt-breakdown.ts *)
  - Bash(bun scripts/traces-list.ts *)
  - Bash(bun scripts/session-analyze.ts *)
  - Bash(bun scripts/daily-report.ts *)
---
